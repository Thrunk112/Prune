...
local RemoveNearCap = {
    ...
    ["Spell_Shadow_UnsummonBuilding"] = "Bloodmoon Vampirism",
    ["Spell_Nature_UndyingStrength"]  = "Ancestral Healing",
    ["Spell_Holy_BlessingOfAgility"]  = "Blessing of the Claw",
    ["INV_Shield_06"]                 = "Inspiration",
    ["Spell_Holy_InnerFire"]          = "Faithful", --Inner fire issue? 
    ["Spell_Nature_HealingWay"]       = "Healing Way",
    ["Spell_Holy_AuraMastery"]        = "Daybreak",
    ["Spell_Holy_Renew"]              = "Renew",
    ["Spell_Nature_Rejuvenation"]     = "Rejuvenation",
    ["Spell_Nature_ResistNature"]     = "Regrowth",
    ["Spell_Nature_BloodLust"]        = "Thirst for Blood / Bloodlust",
    ["Spell_Fire_Fire"]               = "Cozy Fire / Chili / Rocket Boots?", --remove in rocket boots
    --["Spell_Shadow_Haunting"]         = "Ghost Costume",
    --["INV_Misc_Head_Gnome_02"]        = "Gnome Costume (Pink)",
    --["INV_Misc_Head_Gnome_01"]        = "Leper Gnome Costume",
    --["Ability_Kick"]                  = "Speed Potion / Ninja Costume",  --remove if IshowSpeeed potion
